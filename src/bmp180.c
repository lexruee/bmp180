...
int32_t bmp180_register_table[11][3] = {
		...
		{BMP180_REG_AC3_H, 1, 2},
		{BMP180_REG_AC4_H, 0, 3},
		{BMP180_REG_AC5_H, 0, 4},
		{BMP180_REG_AC6_H, 0, 5},
		{BMP180_REG_B1_H, 1, 6},
		{BMP180_REG_B2_H, 1, 7},
		{BMP180_REG_MB_H, 1, 8},
		{BMP180_REG_MC_H, 1, 9},
		{BMP180_REG_MD_H, 1, 10}
};
...
/*
 * Returns the raw measured pressure value of this sensor.
 * 
 */
